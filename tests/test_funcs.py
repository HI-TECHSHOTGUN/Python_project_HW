...
def test_filter_by_state(test_filter_by_state_list):
    assert filter_by_state(test_filter_by_state_list, 'EXECUTED') == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                                                                                                   {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]
    assert  filter_by_state(test_filter_by_state_list, 'NOT_List') == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                                                                                                   {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]
...
def test_parametrize_filter_by_state(test_filter_by_state_list, test_state):
    assert filter_by_state(test_filter_by_state_list, test_state) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},

                                                                                                               {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]

def test_sort_by_date(test_sort_by_date_false, test_sort_by_date_true, test_filter_by_state_list, test_sort_by_date_clone, test_sort_by_date_none_tipical):
